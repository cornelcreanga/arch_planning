...
<html>
	...
	<body>
		<a href="#edit-feature" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-feature" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:featureInstance, action:'update']" method="PUT" >
