	...
	<body>
		...
		<div id="show-link" class="content scaffold-show" role="main">
			...
			<ol class="property-list link">
				...
				<g:if test="${linkInstance?.note}">
				<li class="fieldcontain">
					<span id="note-label" class="property-label"><g:message code="link.note.label" default="Note" /></span>
					
						<span class="property-value" aria-labelledby="note-label"><g:fieldValue bean="${linkInstance}" field="note"/></span>
